...
function AboutUs(){
    return(
        ...
        <div>
        <img src={ require('./img/aboutus.png') } width='100%' height='100%' alt="mainlogo" margin-bottom= "20px"/>
        </div>
        </Container>
        ...
        <Container style={{padding: '0px'}}>
        <div>
        <img src={ require('./img/aboutusins.png') } width='100%' height='100%' alt="mainlogo" margin-bottom= "20px"/>
        </div>
        </Container>
