...
function AboutUs(){
    return(
        ...
        <div>
        <img src={ require('./imgs/aboutus.png') } width='100%' height='100%' alt="mainlogo" margin-bottom= "20px"/>
        </div>
        </Container>
        ...
        <Container style={{padding: '0px'}}>
        <div>
        <img src={ require('./imgs/aboutusins.png') } width='100%' height='100%' alt="mainlogo" margin-bottom= "20px"/>
        </div>
        </Container>
        ...
        <Col>
             <div className = "profile-align-center">
                 <img src = "/imgs/Oh.jpg" style={{width:'160px', height:'200px'}}></img>
          ...
          <Col>
             <div className = "profile-align-center">
                 <img src = "/imgs/Ko.jpeg" style={{width:'160px', height:'200px'}}></img>
          ...
          <Col>
             <div className = "profile-align-center">
                 <img src = "/imgs/Jeong.jpeg" style={{width:'150px', height:'200px'}}></img>
        ...
        <Row>
          ...
          <Col>
             <div className = "profile-align-center">
                 <img src = "/imgs/Jeon.jpeg" style={{width:'150px', height:'200px'}}></img>
