...
import DisplayJackets from '../components/DisplayJackets';
	...
	return (
		<div className ='Mypage'>
			<Container style={{padding: '0px'}}>
				<div>
					<img src={ require('./imgs/mypage.png') } width='100%' height='100%' alt="mainlogo" margin-bottom= "20px"/>
				</div>
			</Container>
			...
			<Container style={{marginBottom : '20px' , border : '1px solid #d9d9d9', padding: '20px' , background: '#f7f7f7'}}>
				<div class = "profile-user-img">
					<img src="/img/profile2.png" alt="profile-user-img" class="profile-user-img-img"/>
				</div>
				<br/>
				<h1>Account</h1>
				<h5>{props.account} </h5>
