...
const Minting = (props) => {
	...
	return(
		...
		<div>
		<img src={ require('./imgs/minting.png') } style = {{width:'100%', height:'100%', alt:"mainlogo", marginBottom: "20px", textAlign: 'center'}} />
		<img src={ require('./imgs/mintingins.png') } style = {{width:'100%', height:'100%', alt:"mainlogo", marginBottom: "20px", textAlign: 'center'}}/>
		</div>
		</Container>
