                        ...
                        <div className="row mt-4">
                            ...
                            <div className="col-lg-3 col-md-6 mb-4 mb-md-0" style = {{}}>
                                ...
                                <a className="btn btn-outline-light btn-floating m-1 text-white"
                                                role="button" href='https://www.instagram.com/o.o.o.team1'><i className="fab fa-facebook-f"></i></a>


                                <a className="btn btn-outline-light btn-floating m-1 text-white"
                                                role="button" href='https://www.instagram.com/o.o.o.team1'><i className="fab fa-twitter"></i></a>


                                <a className="btn btn-outline-light btn-floating m-1 text-white"
                                                role="button" href='https://www.instagram.com/o.o.o.team1'><i className="fab fa-google"></i></a>
